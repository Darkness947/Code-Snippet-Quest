...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    private fun insertInitialQuestions(db: SQLiteDatabase?) {
        val questions = listOf(
            arrayOf("1", "System.out.println(10 + 20 + \"Java\" + 10 + 20);", "What is the output of the code snippet above?", "30Java30", "1020Java1020", "30Java1020", "Compilation Error", "C"),
            arrayOf("1", "String s1 = \"Code\";\nString s2 = new String(\"Code\");\nSystem.out.println(s1 == s2);", "What is the output?", "true", "false", "Compilation Error", "Runtime Exception", "B"),
            arrayOf("1", "int x = 1;\nswitch(x) {\n    case 1: System.out.print(\"A\");\n    case 2: System.out.print(\"B\"); break;\n    case 3: System.out.print(\"C\");\n}", "What is the output?", "A", "B", "AB", "ABC", "C"),
            arrayOf("2", "for (int i = 0; i < 5; i++) {\n    if (i % 2 == 0) continue;\n    System.out.print(i);\n}", "What is the output?", "01234", "024", "13", "135", "C"),
            arrayOf("2", "int x = 5;\nSystem.out.println(x++ + ++x);", "What is the output?", "10", "11", "12", "13", "C"),
            arrayOf("2", "int x = 10;\nint y = (x > 5) ? (x < 15 ? 1 : 2) : 3;\nSystem.out.println(y);", "What is the output?", "1", "2", "3", "10", "A"),
            arrayOf("3", "String s = \"Hello\";\ns.concat(\" World\");\nSystem.out.println(s);", "What is the output?", "Hello World", "World", "Hello", "NullPointerException", "C"),
            arrayOf("3", "class A {\n    A() { System.out.print(\"A\"); }\n}\nclass B extends A {\n    B() { System.out.print(\"B\"); }\n}\npublic class Main {\n    public static void main(String[] args) {\n        new B();\n    }\n}", "What is the output?", "B", "A", "AB", "BA", "C"),
            arrayOf("3", "class Counter {\n    static int count = 0;\n    Counter() { count++; }\n}\npublic class Main {\n    public static void main(String[] args) {\n        Counter c1 = new Counter();\n        Counter c2 = new Counter();\n        System.out.println(Counter.count);\n    }\n}", "What is the output?", "0", "1", "2", "Compilation Error", "C"),
            arrayOf("4", "try {\n    int x = 5 / 0;\n} catch (ArithmeticException e) {\n    System.out.print(\"C\");\n} finally {\n    System.out.print(\"F\");\n}", "What is the output?", "C", "F", "CF", "FC", "C"),
            arrayOf("4", "int[] arr = new int[3];\narr[0] = 1;\narr[1] = 2;\narr[2] = 3;\nSystem.out.println(arr[3]);", "What is the output?", "3", "0", "null", "ArrayIndexOutOfBoundsException", "D"),
            arrayOf("4", "public class Main {\n    public static void modify(int[] a) {\n        a[0] = 99;\n    }\n    public static void main(String[] args) {\n        int[] nums = {1, 2, 3};\n        modify(nums);\n        System.out.println(nums[0]);\n    }\n}", "What is the output?", "1", "99", "Compilation Error", "0", "B")
        )
    ...
    // --- History Operations ---
    fun addHistoryRecord(userId: Int, levelName: String, score: Int, status: String, date: String) {
        val db = this.writableDatabase
        val values = ContentValues().apply {
...
data class Question(val id: Int, val level: Int, val snippet: String, val text: String, val opA: String, val opB: String, val opC: String, val opD: String, val correct: String)
data class HistoryRecord(val id: Int, val userId: Int, val levelName: String, val score: Int, val status: String, val date: String)
